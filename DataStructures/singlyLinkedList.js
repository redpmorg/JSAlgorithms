...
* called nodes pointing to the next node by means of pointer.
* It is a data structure consisting of a group of nodes which
* together represent a sequence. Under the simplest form, each
* node is composed of data and a reference (in other words, a link)
...
SinglyLinkedList.prototype.add = function(data) {
  ...
  if(!this.head) {
    ...
    this.tail = node;
  	...
  	// this.tail.next pointing on same object property as this.head.next,
  	// so this.head.next will be modified as well!!!
    this.tail.next = node;
    this.tail = node;
  }
  this.numberOfValues++;
