 ...
 * with which it is associated. All the descendants of a node have a common prefix
 * of the string associated with that node, and the root is associated with the
 * empty string. Values are not necessarily associated with every node. Rather,
